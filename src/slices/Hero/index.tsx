...
export default function Hero({ slice }: HeroProps) {
	return (
		<section className="mx-auto grid min-h-[75vh] w-[calc(100vw-4rem)] max-w-screen-xl grid-flow-dense content-center items-center gap-8 py-16 md:grid-cols-2 md:gap-10 lg:gap-24 lg:py-40">
			<PrismicNextImage
