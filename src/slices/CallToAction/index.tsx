...
export default function CallToAction({ slice }: CallToActionProps) {
	return (
		<section className="mx-auto max-w-screen-xl py-16 md:w-[calc(100vw-4rem)] lg:py-40">
			<div className="relative grid-cols-2 items-center overflow-hidden bg-white dark:bg-slate-950 sm:grid md:rounded-lg">
				<PrismicNextImage
